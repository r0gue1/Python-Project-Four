...
# r0gue1 # checks for valid input
    try:        
        playerBall = abs(int(input("How many balls do you want to take?  ")))
# r0gue1 # if input is a string, print error message
    except ValueError:
        print("\nPlease enter only valid integers.")
# rogue1 # terminates program
        raise SystemExit 
